...
"@ -split "`r`n"
    ...
    It '測試 Task4: 從本地上傳檔案到遠端' {
        $results = ScpExecutor -RemoteHost RedHat79 Task4 -WhatIf 6>&1
        $results.Count | Should -Be 2
    ...
    It '測試 Task1, Task2, Task3, Task4: 統合一起是否能正確執行' {
        ...
        $results = ScpExecutor -RemoteHost RedHat79 -TaskName Task1,Task2,Task3,Task4 -WhatIf 6>&1
